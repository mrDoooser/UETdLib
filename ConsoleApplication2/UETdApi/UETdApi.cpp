...
//float UETdApi::GetValue()
//{
//	return 2.52f;
//}
//
//void UETdApi::TdExample()
//{
...
void UETdApi::Initialize(FTdApiInitParams *init_params)
{
	...
	//ReadData();
	std::cerr <<  " UETdApi::Initialize() "  << std::endl;
}

void UETdApi::ReadData()
{
	//while (true) {

		if (client_ == nullptr)
		{
			std::cerr << " client_ == nullptr " << std::endl;
			return;
		}
...
void UETdApi::AuthorizationStateWaitTdlibParameters()
{
	...
	func();
	auto parameters = td_api::make_object<td_api::tdlibParameters>();
	parameters->database_directory_ = "UEChatTest";
	parameters->use_message_database_ = true;
	parameters->use_secret_chats_ = true;
	parameters->api_id_ = 1168701;
	parameters->api_hash_ = "bb8f4331914e98f512c8bae1deed523e";
